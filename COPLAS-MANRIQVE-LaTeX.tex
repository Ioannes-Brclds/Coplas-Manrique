...
de verdad\footnoteC{En \textit{LB3} se redactó \comillas{[de ver] dat} luego de \comillas{ynuoco yo}. Quizá el redactor inicial —o un secundario [\textit{cfr. gl.} XL]— tachó el fragmento por la errónea ubicación y corrigió \comillas{de verdad} en un pequeño espacio entre los vv. 44 y 46. Puesto que se modificó \textit{verdat} por \textit{verdad} en la corrección, para la fijación se reemplazó \textit{t} en \textit{deydat} por \textit{d} para conservar la rima.} \edtext{}{\lemma{\hspace*{-1em}}\Afootnote[nosep]{\textit{p. corr. LB3}}},\\
...
Las justas y los torneos,\edtext{}{\linenum{|||||189}\lemma{\hspace*{-1em}}\Afootnote[nosep]{\hspace*{-0.5em}/190–192 ~\textit{transp. 86*RL}}}\\
