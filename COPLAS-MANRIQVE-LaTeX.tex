...
\Xsymlinenum{\hspace*{-0.5em}$||$}
\geometry{paperwidth=17cm,paperheight=25cm,top=1.45cm,inner=1.75cm,outer=1.45cm,bottom=2.54cm}
...
\setmainfont[Numbers=Lining,BoldFont={}]{Times New Roman}
...
\textit{83*IM}= \textit{Cancionero de fray Íñigo de Mendoza}, Biblioteca Nacional de España, INC/897.
...
~\textit{⁊}= \textit{et tironiano} se interpreta por \textit{e}.
...
Constituyen al aparato crítico el orden y rúbricas en los testimonios, el aparato de variantes textuales y los comentarios adicionales. El tipo de aparato de variantes es negativo. Luego de indicar el pasaje al que corresponde la variante —si se coloca \comillas{||}, indicará que aún continúa en el mismo pasaje—, se colocará la lección adoptada seguida por el signo \comillas{]} que encierra la lección adoptada, y tras el signo, las lecciones descartadas seguidas por su(s) sigla(s)\footnote{Irán en cursiva las siglas y se separarán con comas cada una.}, separada cada unidad por un \comillas{;}. Un ejemplo con la copla V:\vspace{-6pt}
\begin{flushright}
56 quando] mientra \textit{δ}; quanto \textit{HH1}.
\end{flushright}\vspace{-1pt}
{\setlength{\parindent}{0pt}Se eludirán variantes gráficas y de espacio. Los comentarios contendrán argumentos en torno a las lecciones adoptadas, problemas respecto al estado del testimonio de base —correcciones, entre otros— y plausibles interpretaciones al texto.}
...
\edtext{q\textit{ua}lq\textit{uie}ra}{\Afootnote{qualqujer \textit{LB3}}} tie\textit{n}po pasado \edtext{}{\lemma{\hspace*{-1em}}\Afootnote[nosep]{sapado \textit{err. LB3}}}
...
\begin{center}
		[III]\footnoteA{ Rúbrica= \comillas{conpara} \textit{LB3}.}
\end{center}
\pstart
...
y más chicos,\\
\edtext{y llegados}{\Afootnote{alleguados \textit{82*JM}; allegados \textit{83*IM}}}\footnoteC{ \textcite{PérezPriego2017} sugiere que la lección \textit{alleguados}, a través de la contaminación de \textit{82*JM} hacia el subarquetipo \textit{β}, habría generado la lección \textit{allegados}, que Beltrán utilizó para sus ediciones críticas.}, son iguales,\\
...
\begin{center}
	[IV]\footnoteA{ Rúbrica= «ynuoca» \textit{LB3}; «inuocaçion» \textit{82*JM}; «Inuocacion» \textit{86*RL}.}
\end{center}
\pstart
...
aq\textit{ue}l solo invoco yo \edtext{}{\lemma{\hspace*{-1em}}\Afootnote[nosep]{de verdat \textit{a. corr. LB3}}}

de verdad\footnoteC{ En \textit{LB3} se redactó \comillas{[de ver] dat} luego de \comillas{ynuoco yo}. Quizá el redactor inicial —o un secundario [\textit{cfr. c.} XL]— tachó el fragmento por la errónea ubicación y corrigió \comillas{de verdad} en un pequeño espacio entre los vv. 44 y 46. Y ya que se modificó \comillas{\textit{verdat}} por \comillas{\textit{verdad}} en la corrección, se reemplaza \textit{t} en \comillas{deydat} por \textit{d} para conservar la rima.} \edtext{}{\lemma{\hspace*{-1em}}\Afootnote[nosep]{\textit{p. corr. LB3}}},\\
...
\begin{center}
	[V]\footnoteA{ Rúbrica= \comillas{ap[lica] y [co]\textit{n}para} \textit{ras. LB3}.}
	\end{center}
\pstart
...
para andar esta \edtext{jornada}{\Afootnote{este camino \textit{82*JM}}}
...
\begin{center}
	[VI]\footnoteA{ Rúbrica= \comillas{p\textit{r}osigue} \textit{LB3}.}
\end{center}
\pstart
...
\begin{center}
	[VII]\footnoteA{ XXV en \textit{82*JM}; XIII en \textit{86*RL}.}
\end{center}
\pstart
...
corporal\\
como podemos fazer\\ al \edtext{ánima}{\lemma{anima}\Afootnote{alma \textit{86*RL}, \textit{HH1}}} \edtext{glorïosa}{\lemma{gloriosa}\Afootnote{tan gloriosa \textit{86*RL}, \textit{HH1}}}
...
\begin{center}
	[VIII]\footnoteA{ VII en \textit{86*JM}.}
\end{center}
\pstart
...
\begin{center}
	[IX]\footnoteA{ VIII en \textit{82*JM}, \textit{86*RL}.}
\end{center}
\pstart
...
\begin{center}
	[X]\footnoteA{ IX en \textit{82*JM}, \textit{86*RL}.}
\end{center}
\pstart
...
\begin{center}
	[XI]\footnoteA{ X en \textit{82*JM}, \textit{86*RL}.}
\end{center}
\pstart
...
que se muda:\\
que bienes son de Fortuna\\ que \edtext{rebuelve}{\lemma{rebuelue}\Afootnote{rebueluen \textit{δ}}} co\textit{n} su rueda
...
\begin{center}
	[XII]\footnoteA{ XI en \textit{82*JM}, \textit{86*RL}.}
\end{center}
\pstart
...
co\textit{n} su dueño;\\
\edtext{por eso}{\Afootnote{por esto \textit{82*JM}; mas por eso \textit{HH1}}} no \edtext{nos engañen}{\Afootnote{engañe \textit{LB3}; sengañen \textit{HH1}}}\footnoteC{ Se adoptan las lecciones de número plural del texto mayoritario frente a las de número singular —esto es, \comillas{aco\textit{n}pañe}, \comillas{llegue} y \comillas{engañe}— que porta \textit{LB3}.},\\
pues se va la vida \edtext{apriesa}{\Afootnote{espesa \textit{MN19}}}

como sueño.\\
Y\edtext{}{\lemma{y}\Afootnote{q\textit{ue HH1}}} los \edtext{plazeres}{\Afootnote{deleytes \textit{δ}, \textit{ε}, \textit{83*IM}}} de acá\\
...
\begin{center}
	[XIII]\footnoteA{ XII en \textit{82*JM}, \textit{86*RL}.}
\end{center}
\pstart
...
\begin{center}
	[XIV]\footnoteA{ XXVI en \textit{82*JM}.}
\end{center}
\pstart
...
\begin{center}
	[XV]\footnoteA{ XXVII en \textit{82*JM}.}
\end{center}
\pstart
...
\begin{center}
	[XVI]\footnoteA{ XXVIII en \textit{82*JM}.}
\end{center}
\pstart
...
de las eras? \footnoteC{ 187-189/190-192 \textit{transp. 86*RL}.}
\pend

\begin{center}
	[XVII]\footnoteA{ XXIX en \textit{82*JM}.}
\end{center}
\pstart
...
\begin{center}
	[XVIII]\footnoteA{ XXX en \textit{82*JM}.}
\end{center}
\pstart
...
\begin{center}
	[XIX]\footnoteA{ XXXI en \textit{82*JM}.}
\end{center}
\pstart
...
\edtext{de su gente}{\Afootnote{desta gente \textit{82*JM}; de sus gentes \textit{86*RL}; y sus gentes \textit{HH1}; \textit{om. MN19}}} y atavíos
...
\begin{center}
	[XX]\footnoteA{ XXXII en \textit{82*JM}.}
\end{center}
\pstart
...
\begin{center}
	[XXI]\footnoteA{ XXXIII en \textit{82*JM}.}
\end{center}
\pstart
...
\begin{center}
	[XXII]\footnoteA{ XXXIV en \textit{82*JM}.}
\end{center}
\pstart
...
\begin{center}
	[XXIII]\footnoteA{ XXXV en \textit{82*JM}.}
\end{center}
\pstart
...
y en las pazes,\\
q\textit{ua}ndo tú, cruda\footnoteC{ \comillas{cruda}= \comillas{Se toma tambien por cruel, áspero, sangriento y desapiadado.} (\textit{Diccionario de Autoridades}, 3ª).}, te ensañas,\\
...
\begin{center}
	[XXIV]\footnoteA{ XXXVI en \textit{82*JM}.}
\end{center}
\pstart
...
\begin{center}
	[XXV]\footnoteA{ XIII en \textit{82*JM}. Rúbrica= \comillas{dirige la fabla al maestre do\textit{n} rodrigo su padre} \textit{LB3}; \comillas{ffabla del maestre do\textit{n} rr\textit{odri}go ma\textit{n}riq\textit{ue}} \textit{HH1}.}
\end{center}
\pstart
Aquel de \edtext{buenos}{\Afootnote{bienes \textit{MN19}}} abrigo,\\ amado por virtuoso
...
\begin{center}
	[XXVI]\footnoteA{ XIV en \textit{82*JM}.}
\end{center}
\pstart
...
\begin{center}
	[XXVII]\footnoteA{ XV en \textit{82*JM}. Rúbrica= \comillas{conpara} \textit{LB3}.}
\end{center}
\pstart
En \edtext{}{\lemma{\hspace*{-1em}}\Afootnote[nosep]{en [la] \textit{eras. LB3}}} ventura, \edtext{Otavïano}{\lemma{otauiano}\Afootnote{octoniano \textit{82*JM}}},\\
...
\begin{center}
	[XXVIII]\footnoteA{ XXVI en\textit{82*JM}. Rúbrica= \comillas{prosigue} \textit{LB3}.}
\end{center}
\pstart
...
\begin{center}
	[XXIX]\footnoteA{ XVII en \textit{82*JM}; XXX en \textit{HH1}.}
\end{center}
\pstart
No dexó grandes thesoros\\
ni \edtext{alcançó}{\lemma{alcanço}\Afootnote{llego HH1}} \edtext{gra\textit{n}des}{\Afootnote{muchas 86*RL}} riq\textit{ue}zas 

ni baxillas,\\
mas fizo \edtext{guerras a moros}{\Afootnote{guerra a los moros \textit{δ}, \textit{MN19}, \textit{83*IM}; gran guerra a moros \textit{HH1}}}\footnoteC{ «guerras a moros» en \textit{LB3}. Se siguen las lecciones plurales de \textit{LB3}, porque don Rodrigo Manrique probablemente no participó en una guerra, sino en otras más. Es necesario atender a los datos proporcionados por Fernando del Pulgar en su \textit{Claros varones de Castilla} [ca. 1480-1486] que, en un capítulo dedicado al maestre, el XIII, titulado «El Maestre Don Rodrigo Manrrique, Conde de Paredes» —que ya citó \textcite[cap. IX]{MenendezYPelayo1944}—, los recoge con gran detalle. A continuación, el texto según la edición crítica de Tate:\\
...
gana\textit{n}do sus fortalezas \edtext{}{\lemma{\hspace*{-1em}}\Afootnote[nosep]{fortalezas [y villas] \textit{eras. LB3}}}
...
\begin{center}
	[XXX]\footnoteA{ XVIII en \textit{82*JM}; XXIX en \textit{HH1}.}
\end{center}
\pstart
...
que le diero\textit{n} \edtext{aún}{\lemma{avn}\Afootnote{muy \textit{83*IM}}} más \edtext{t\textit{ie}rras}{\Afootnote{tierra \textit{δ}, \textit{ε}, \textit{83*IM}}}\footnoteC{ Lecciones plurales de \textit{LB3}. \textit{cfr. pr. c.}}  

\edtext{que}{\Afootnote{quel \textit{82*JM}}} tenía.
\pend

\begin{center}
	[XXXI]\footnoteA{ XIX en \textit{82*JM}.}
\end{center}
\pstart
...
\begin{center}
	[XXXII]\footnoteA{ XX en \textit{82*JM}.}
\end{center}
\pstart
...
si de las obras que obró\footnoteC{ 379-380 \textit{transp. LB3}= \comillas{si de las obras que obro / el nuestro rey natural}.}

fue servido,\\
dígalo el de Portugal,\\
\edtext{y en}{\Afootnote{a \textit{om. LB3}; si en \textit{86*RL}; quien en \textit{HH1}}} Castilla, quien siguió  

su partido.                                                                                          
\pend

\begin{center}
	[XXXIII]\footnoteA{ XXI en \textit{82*JM}.}
\end{center}
\pstart
...
vino la Muerte a llamar\edtext{}{\lemma{\hspace*{-1em}}\Afootnote[nosep]{lamar \textit{err. 83*IM}}}

a su puerta, 
\pend

\begin{center}
	[XXXIV]\footnoteA{ XXII en \textit{82*JM}. Rúbrica= \comillas{ffabla la muerte con el maestre} \textit{LB3}.}
\end{center}
\pstart
diziendo: «bue\textit{n} cavallero,\\
dexad el mu\textit{n}do engañoso                                                               

\edtext{sin falago}{\Afootnote{y su [\textit{f}|\textit{h}]alago \textit{δ}, \textit{ε}; con halago \textit{83*IM}}}\footnoteC{ Los demás testimonios transmiten «y su [\textit{f}-\textit{h}]alago», que parece tener más sentido, pero que incurre en una hipermetría, porque \textit{h} corresponde a una consonante aspirada, muda o una \textit{f} inicial latina, ya que entre los testimonios alternan \textit{h} [\textit{86*RL}] y \textit{f} [\textit{HH1}, \textit{MN19}], y alguno la omite [\textit{82*JM}]; de ser así esto, algo apreciable por la inestabilidad gráfica, la sinalefa no sería posible y, por tanto, sería conveniente adoptar la lección de \textit{LB3}, que es un tetrasílabo. La lección \textit{sin falago} apuntaría —probablemente— a que don Rodrigo Manrique debería dejar «el mundo engañoso / sin [\textit{atender al} / \textit{seguir su}] falago», un sentido más o menos similar. Quizá la lección \textit{y su }[\textit{f}-\textit{h}]\textit{alago} incurre en una lectio facilior.};\\
...
\begin{center}
	[XXXV]\footnoteA{ XXIII en \textit{82*JM}.}
\end{center}
\pstart
...
\edtext{ni}{\Afootnote{\textit{om. 83*IM}}} \edtext{duradera}{\Afootnote{verdadera \textit{δ}, \textit{MN19}}},\\
...
\begin{center}
	[XXXVI]\footnoteA{ XXIV en \textit{82*JM}.}
\end{center}
\pstart
...
\begin{center}
	[XXXVIII]\footnoteA{ Rúbrica= «rresponde don rrodrigo manrrique a la muerte» \textit{LB3}; «Respuesta del maestre» \textit{82*JM}; «Reza a la muerte» \textit{86*RL}; «Respondel Maestre» \textit{MN19}, \textit{83*IM}.}
\end{center}
\pstart
...
Coplas apócrifas en la \comillas{\textit{Glosa Famossisima}} de Alonso de Cervantes, ubicadas entre las coplas XXIV y XXV. Texto fijado por \textcite{Foulché-Delbosc1902}.\vspace{5pt}
...
\begin{pairs}
	...
	\begin{Rightside}
		...
		\noindent\hspace*{0.5cm}toda vida,\\
		mas segun aca nos tratas,\\
		lo mejor y menos triste\\
		\noindent\hspace*{0.5cm}es la partida\\
		de tu vida tan cubierta\\ de males, y de dolores\\
		\noindent\hspace*{0.5cm}tan poblada,\\
		de los bienes tan desierta,\\
		de plazeres y dulçores\\
		\noindent\hspace*{0.5cm}despoblada.
		\pend
		\endnumbering
	\end{Rightside}
\end{pairs}
...
\vspace{11pt}Tras la copla XL, en \textit{83*IM} yace un epitafio con la rúbrica \comillas{En su sepultura dize desta manera}.\vspace{5pt}

	Aquí yaze muerto el ombre\\ que vivo queda su nombre.\footnoteA{ Beltrán, citando a Luis de Salazar y Castro, recupera «AQVI YACE MVERTO VN HOMBRE, QVE VIVO DEJO SV NOMBRE» \parencite[158]{Beltrán1991}.}
%Espacio para que el comando que ejecuta el sistema no se quiebre. 
\end{document}
