...
\usepackage{fontspec}
\usepackage[paperwidth=17.5cm,paperheight=25.5cm,top=1.4cm,inner=1.75cm,outer=1.4cm,bottom=2.54cm]{geometry}
...
\author{GIORGII MANRICI}
\date{\fontsize{9}{11}\selectfont{CVM APPARATV CRITICO INSTRVXIT}\\\fontsize{40}{11}\selectfont{\vfill\LaTeX}}
%Aquí cierran los comandos para el documento.
\Xarrangement{paragraph}
\Xnumberonlyfirstinline
\Xnumberonlyfrstintwolines
\Xsymlinenum{$//$}}
...
\setmainfont[Numbers=Lining,BoldFont={}]{old standard}
...
\setcounter{page}{1}
\section*{{\fontsize{13}{14.35}\selectfont PREFACIO}}
...
\section*{\fontsize{13}{14.35}\selectfont TESTIMONIOS\footnote{Se adoptan las siglas utilizadas por \textcite{PérezPriego2017} quien, a su vez, las adopta de Dutton a partir de \textit{El cancinonero del s. XV (ca. 1360-1520)} [7 vols.], texto que para la presente edición no pudo consultarse.}}
...
\section*{{\fontsize{13}{14.35}\selectfont CONSPECTUS SIGLORUM}}
...
Coplas apócrifas en la \textit{Glosa Famossisima} de Alonso de Cervantes, ubicadas entre las coplas XXIV y XXV. Texto fijado por \textcite{Foulché-Delbosc1902}.\vspace{5pt}
