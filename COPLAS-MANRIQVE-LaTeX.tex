...
\Xprenotes{11pt}
\prenotesX{11pt}
\Xafterrule{1pt plus 2pt minus 0.5pt}
\afterruleX{1pt plus 2pt minus 0.5pt}
%
...
\setcounter{page}{1}
\section*{{\fontsize{13}{14.35}\selectfont APUNTES}}
...
\vspace{11pt}Tras la copla XL, en \textit{83*IM} yace un epitafio con la rúbrica \comillas{En su sepultura dize desta manera}:\vspace{5pt}
	...
	Aquí yaze muerto el ombre\\ que vivo queda su nombre.\footnote{ Beltrán, citando a Luis de Salazar y Castro, recupera «AQVI YACE MVERTO VN HOMBRE, QVE VIVO DEJO SV NOMBRE» \parencite[158]{Beltrán1991}.}
%Espacio para que el comando que ejecuta el sistema no se quiebre. 
\end{document}
