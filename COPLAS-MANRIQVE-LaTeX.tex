...
%
\setmainfont{FreeSerif}[ItalicFont=FreeSerif Italic,BoldFont=,Numbers=Lining] %%Por algún motivo que desconozco, a partir de la fecha fontspec no está aplicando la cursiva de FreeSerif con la simple implementación de \setmainfont{}, cuando los archivos .otf están en la carpeta fonts de Linux Mint; entonces, fue necesario definir la cursiva para que lo adopte para esta actualización.
