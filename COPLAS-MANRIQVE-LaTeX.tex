...
\section*{\fontsize{13}{14.35}\selectfont TESTIMONIOS\footnoteE{Se adoptan las siglas utilizadas por \textcite{PérezPriego2017} quien, a su vez, las adopta de Dutton a partir de \textit{El cancinonero del s. XV (ca. 1360-1520)} [7 vols.].}}
		...
		\begin{tikzpicture}[%
			...
			child {node {α}
				...
				child {node {γ}
					child {node {δ}
						child {node {82*JM}}
						child [yshift=-20pt]{node {86*RL}}
					}
					child [yshift=-70pt] {node {ε}
						child {node {HH1}}
						child {node {MN19}}
					}
				}
...
sin parar;\\
\edtext{desque}{\Afootnote{cuando \textit{HH1}, \textit{83*IM}}}\footnoteE{Conjunción \comillas{desde que}.} vemos el engaño,\\
