...
\begin{center}
		[III]\footnoteA{ \comillas{conpara} \textit{LB3}.}
\end{center}
\pstart
...
\begin{center}
	[IV]\footnoteA{ «ynuoca» \textit{LB3}; «inuocaçion» \textit{82*JM}; «Inuocacion» \textit{86*RL}.}
\end{center}
\pstart
...
\begin{center}
	[V]\footnoteA{ \comillas{ap[lica] y [co]\textit{n}para} \textit{ras. LB3}.}
	\end{center}
\pstart
...
\begin{center}
	[VI]\footnoteA{ \comillas{p\textit{r}osigue} \textit{LB3}.}
\end{center}
\pstart
...
\begin{center}
	[XXV]\footnoteA{ XIII en \textit{82*JM}. || \comillas{dirige la fabla al maestre do\textit{n} rodrigo su padre} \textit{LB3}; \comillas{ffabla del maestre do\textit{n} rr\textit{odri}go ma\textit{n}riq\textit{ue}} \textit{HH1}.}
\end{center}
\pstart
...
\begin{center}
	[XXVII]\footnoteA{ XV en \textit{82*JM}. || \comillas{conpara} \textit{LB3}.}
\end{center}
\pstart
...
\begin{center}
	[XXVIII]\footnoteA{ XXVI en \textit{82*JM}. || \comillas{prosigue} \textit{LB3}.}
\end{center}
\pstart
...
\begin{center}
	[XXXIV]\footnoteA{ XXII en \textit{82*JM}. || \comillas{ffabla la muerte con el maestre} \textit{LB3}.}
\end{center}
\pstart
...
\begin{center}
	[XXXVIII]\footnoteA{ «rresponde don rrodrigo manrrique a la muerte» \textit{LB3}; «Respuesta del maestre» \textit{82*JM}; «Reza a la muerte» \textit{86*RL}; «Respondel Maestre» \textit{MN19}, \textit{83*IM}.}
\end{center}
\pstart
...
\begin{center}
	[XXXIX]\footnoteA{ «oraçion que fizo el maestre» \textit{LB3}; «Oracion» \textit{ 82*JM}, \textit{86*RL}, \textit{83*IM}; «Oracion quel Maestre face á Dios» \textit{MN19}.}
\end{center}
\pstart
...
\begin{center}
    [XL]\footnoteA{ «fin» \textit{LB3}, \textit{86*RL}, \textit{MN19}; «Torna el actor y faze fin» \textit{82*JM}.}
\end{center}
\pstart
...
\vspace{11pt} Tras la copla XL, en \textit{83*IM} yace un epitafio con la rúbrica \comillas{En su sepultura dize desta manera}, que enuncia: \comillas{Aquí yaze muerto el ombre / que vivo queda su nombre.}\footnoteC{ Beltrán, citando a Luis de Salazar y Castro, recupera «AQVI YACE MVERTO VN HOMBRE, QVE VIVO DEJO SV NOMBRE» \parencite[158]{Beltrán1991}.}
%Espacio para que el comando que ejecuta el sistema no se quiebre. 
\end{document}
