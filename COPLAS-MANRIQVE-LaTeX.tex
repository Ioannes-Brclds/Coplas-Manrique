...
\usepackage{reledpar}
\usepackage{fontspec}
\usepackage[paperwidth=17.00cm,paperheight=25.50cm,top=1.40cm,inner=1.95cm,outer=1.65cm,bottom=2.50cm]{geometry}
...
%
\setmainfont{Free-serif}[Numbers=Lining,BoldFont=]
...
\vfill
\begin{flushright}
	Edición preparada por I. Brachamons Letesmus.
\end{flushright}

\begin{flushright}
	Documento compuesto en LuaLaTeX con el paquete Reledmac de Maïeul Rouquette.
\end{flushright}
\newpage
%
\tableofcontents
...
Constituyen al aparato crítico el orden y rúbricas en los testimonios, el aparato de variantes y los pie de página adicionales. El tipo de aparato de variantes es negativo. Luego de indicar el pasaje al que corresponde la variante --si se coloca \comillas{||}, indicará que aún continúa en el mismo pasaje--, se colocará la lección adoptada seguida por el signo \comillas{]} que encierra la lección adoptada, y tras el signo, las lecciones descartadas seguidas por su(s) sigla(s)\footnoteE{Irán en cursiva las siglas y se separarán con comas cada una.}, separada cada unidad por un \comillas{;}. Un ejemplo con la copla V: \comillas{56 quando] mientra \textit{δ}; quanto \textit{HH1}}. Se eludirán variantes gráficas y de espacio. Los comentarios contendrán argumentos en torno a las lecciones adoptadas, problemas respecto al estado del testimonio de base --correcciones, entre otros-- y plausibles interpretaciones.
...
co\textit{n} su dueño;\\
\edtext{por eso}{\Afootnote{por esto \textit{82*JM}; mas por eso \textit{HH1}}} no \edtext{nos engañen}{\Afootnote{nos engañe \textit{LB3}; sengañen \textit{HH1}}}\footnoteE{Se adoptaron las lecciones plurales del texto mayoritario frente a las de número singular --esto es, \comillas{aco\textit{n}pañe}, \comillas{llegue} y \comillas{engañe}-- que porta \textit{LB3}.},\\
...
y desfazes\footnoteE{\comillas{guerras/pazes}, \comillas{atierras/desfazes} = es probable que \textit{82*JM} haya leído erróneamente, invirtiendo el orden entre los vv. 272-273 y 275-276, algo que puede conjeturarse por la lección \textit{passos}, quizá una lectura errónea de \textit{pazes} y \textit{guerras}, que aparece en 273, cuando en el resto de testimonios aparece en el 272, al igual que en lugar de \textit{atierras} lee \textit{desfazes} y al revés.}.
\pend
