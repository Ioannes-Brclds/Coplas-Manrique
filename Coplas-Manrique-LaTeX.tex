...
%
\setmainfont{Ecdotica}[BoldFont=,Numbers={OldStyle,Proportional}] %Modified XITS [with the TironianEt (U+204A) and modified oldstyle figures] combinated with IFAO Grec Unicode of Jean-Luc Fournet and GNU FreeSerif.
