...
\vfill
\begin{flushright}
	Edición y composición en LuaLaTeX con Reledmac\\ de \textsc{Maïaevl Rovqvette} por \textsc{Iohannes Bracledivs}.
\end{flushright}
\newpage
%
\tableofcontents
...
Jorge Manrique nació ca. 1440 y murió en abril de 1479. Una noticia de su muerte la transmitió Fernando del Pulgar en su \emph{Crónica de los reyes Católicos}:\par
%
...
%
No se conservaron autógrafos de alguna copla ni testimonios que puedan considerarse apógrafos o idiógrafos. El testimonio más antiguo que contiene la colección de cuarenta coplas es el manuscrito del \emph{Cancionero de Egerton}, y no es sino hasta ca. 1482-83 --seis o siete años tras la redacción y cuatro o cinco tras el fallecimiento del autor-- que aparece en un impreso en carácter de \emph{editio princeps}. Es necesario destacar que los textos de Manrique solo se conservaron disueltos en cancioneros, a diferencia de otros autores como Luis de Góngora, que gozó de \comillas{colecciones} con su obra, constituyendo así un auténtico \emph{corpus}, como puede observarse en el \emph{Códice Chacón} en la BNE.\par
...
las adoptó de Dutton y su \emph{El cancionero del s. XV (ca. 1360-1520)} [7 vols.]. Los testimonios son:\par
%
