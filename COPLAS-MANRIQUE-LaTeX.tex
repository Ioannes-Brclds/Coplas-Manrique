...
\vfill
\begin{flushright}
	Edición preparada por {\fontsize{9}{1}\selectfont IOHANNES BRACHLEDIUS}, y compuesta\\ en LuaLaTeX con el paquete Reledmac de {\fontsize{9}{11}\selectfont MAÏAEUL ROUQUETTE}.
\end{flushright}
\newpage
%
\tableofcontents
