...
%
\setmainfont{TemporaNovusRomanus}[BoldFont=,Numbers={OldStyle,Proportional}] %Modified Nimbus15 [renamed as TemporaNovusRomanus] with a one.oldstyle more high and a TironianEt sign adapted from GNU FreeSerif.
